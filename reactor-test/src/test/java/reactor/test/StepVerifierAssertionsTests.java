...
public class StepVerifierAssertionsTests {
	...
	public void assertDroppedElementsFailureOneExtra() {
		try {
			...
			assertThat(ae)
				.hasMessage("Expected dropped elements to contain <[foo]>, was <[bar, baz]>.");
		}
	}
	...
	public void assertDroppedElementsFailureOneMissing() {
		try {
			...
			assertThat(ae)
				.hasMessage(
					"Expected dropped elements to contain exactly <[baz]>, was <[bar, baz]>."
				);
		}
	}
	...
	public void assertDiscardedElementsAllPass() {
		StepVerifier
			.create(Flux.just(1, 2, 3).filter(i -> i == 2))
			.expectNext(2)
			.expectComplete()
			.verifyThenAssertThat()
	...
	public void assertNotDiscardedElementsFailureOneDiscarded() {
		try {
			StepVerifier
				.create(Flux.just(1, 2).filter(i -> i == 2))
				.expectNext(2)
				.expectComplete()
				.verifyThenAssertThat()
	...
	public void assertDiscardedElementsFailureOneExtra() {
		try {
			...
			assertThat(ae)
				.hasMessage("Expected discarded elements to contain <[4]>, was <[1, 3]>.");
		}
	}
		...
		try {
			StepVerifier
				...
				.hasDiscardedElementsMatching(
					list -> list.stream().allMatch(e -> (int) e % 2 == 0)
				);
			fail("expected an AssertionError");
		} catch (AssertionError ae) {
			assertThat(ae)
				.hasMessage(
					"Expected collection of discarded elements matching the given predicate, did not match: <[1, 3]>."
				);
		}
	}
	...
	public void assertDiscardedElementsFailureOneMissing() {
		try {
			...
			assertThat(ae)
				.hasMessage(
					"Expected discarded elements to contain exactly <[1]>, was <[1, 3]>."
				);
		}
	}
	...
	public void assertDroppedErrorAllPass() {
		...
		StepVerifier
			...
			.hasDroppedErrorMatching(
				t -> t instanceof IllegalStateException && "boom2".equals(t.getMessage())
			);
	}
	...
	public void assertNotDroppedErrorsFailureOneDrop() {
		try {
			...
			assertThat(ae)
				.hasMessage(
					"Expected no dropped errors, found <[java.lang.IllegalStateException: boom]>."
				);
		}
	}
	...
	public void assertDroppedErrorFailureWrongType() {
		try {
			...
			assertThat(ae)
				.hasMessage(
					"Expected dropped error to be of type java.lang.IllegalArgumentException, was java.lang.IllegalStateException."
				);
		}
	}
	...
	public void assertDroppedErrorFailureWrongContains() {
		try {
			...
			assertThat(ae)
				.hasMessage(
					"Expected dropped error with message containing <\"foo\">, was <\"boom2\">."
				);
		}
	}
	...
	public void assertDroppedErrorFailureWrongMessage() {
		try {
			...
			assertThat(ae)
				.hasMessage("Expected dropped error with message <\"boom1\">, was <\"boom2\">.");
		}
	}
	...
	public void assertDroppedErrorFailureWrongMatch() {
		try {
			...
			StepVerifier
				...
				.verifyThenAssertThat()
				.hasDroppedErrorMatching(
					t -> t instanceof IllegalStateException && "foo".equals(t.getMessage())
				);
			fail("expected an AssertionError");
		} catch (AssertionError ae) {
			assertThat(ae)
				.hasMessage(
					"Expected dropped error matching the given predicate, did not match: <java.lang.IllegalStateException: boom2>."
				);
		}
	}
	...
	public void assertDroppedErrorsNotMatching() {
		...
		try {
			...
			assertThat(ae)
				.hasMessage(
					"Expected collection of dropped errors matching the " +
	...
	public void assertOperatorErrorAllPass() {
		...
		StepVerifier
			...
			.hasOperatorErrorMatching(
				t -> t instanceof IllegalStateException && "boom1".equals(t.getMessage())
			);
	}
	...
	public void assertOperatorErrorFailureWrongType() {
		try {
			...
			assertThat(ae)
				.hasMessage(
					"Expected operator error to be of type java.lang.IllegalArgumentException, was java.lang.IllegalStateException."
				);
		}
	}
	...
	public void assertOperatorErrorFailureWrongContains() {
		try {
			...
			assertThat(ae)
				.hasMessage(
					"Expected operator error with message containing <\"foo\">, was <\"boom1\">."
				);
		}
	}
	...
	public void assertOperatorErrorFailureWrongMessage() {
		try {
			...
			assertThat(ae)
				.hasMessage("Expected operator error with message <\"boom2\">, was <\"boom1\">.");
		}
	}
	...
	public void assertOperatorErrorFailureWrongMatch() {
		try {
			...
			assertThat(ae)
				.hasMessage(
					"Expected operator error matching the given predicate, " +
	...
	public void assertOperatorErrorsNotMatching() {
		...
		try {
			...
			assertThat(ae)
				.hasMessageStartingWith(
					"Expected collection of operator errors matching the" +
	...
	public void assertDurationLessThanOk() {
		StepVerifier
			.create(Mono.delay(Duration.ofMillis(500)).then())
			.expectComplete()
			.verifyThenAssertThat()
	...
	public void assertDurationLessThanFailure() {
		try {
			...
			assertThat(ae)
				...
				.hasMessageStartingWith(
					"Expected scenario to be verified in less than 200ms, took 5"
				)
	...
	public void assertDurationConsidersEqualsASuccess() {
		new DefaultStepVerifierBuilder.DefaultStepVerifierAssertions(
			null,
	...
	public void assertDurationFailureWithScenarioName() {
		assertThatExceptionOfType(AssertionError.class)
			...
			.withMessage(
				"[fooScenario] Expected scenario to be verified in less than 200ms, took 3000ms."
			);
	}
	...
	public void assertDurationMoreThanFailure() {
		try {
			...
			assertThat(ae)
				//the actual duration can vary a bit
				.hasMessageStartingWith(
					"Expected scenario to be verified in more than 800ms, took 5"
				)
				.hasMessageEndingWith("ms.");
		}
	}
